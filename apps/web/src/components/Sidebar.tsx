...
import { IconHome, IconAdmin, IconLayers, IconPower, IconTag, IconExport, IconRuler, IconPlus, IconChevron, IconDashboard, IconCompare, IconKey } from './icons';
      ...
      <div className="rail-group">
        ...
        {user && (
          <div className="rail-user">
            ...
            <RailBtn tip={t('pw.title', lang)} onClick={() => setPwOpen(true)}><IconKey size={18} /></RailBtn>
