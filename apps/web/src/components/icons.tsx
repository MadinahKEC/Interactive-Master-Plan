...
/** Security shield with a keyhole — for the "change password" action (distinctive). */
export const IconKey = ({ size }: P) => (<svg {...S(size)}><path d="M12 3l7 2.6v5.2c0 4.4-3 7.5-7 9.2-4-1.7-7-4.8-7-9.2V5.6L12 3Z" /><circle cx="12" cy="10.4" r="1.7" /><path d="M12 12.1V14.6" /></svg>);
/** Lifebuoy / support ring — for the "system issue contact" affordance. */
export const IconLifebuoy = ({ size }: P) => (<svg {...S(size)}><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="3.4" /><path d="M5.1 5.1l3.5 3.5M15.4 15.4l3.5 3.5M18.9 5.1l-3.5 3.5M8.6 15.4l-3.5 3.5" /></svg>);
