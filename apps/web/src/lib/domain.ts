...
export const DICT: Record<string, Entry> = {
  ...
  // — project groups (feature 3) —
  'pg.mark':         { ar: 'تحديد كمشروع واحد', en: 'Mark as one project' },
  'pg.markHint':     { ar: 'إظهار البلوت المحددة كمشروع واحد باسم راقٍ على الخريطة — دون دمجها.', en: 'Show the selected plots as one named project on the map — without merging them.' },
  'pg.name':         { ar: 'اسم المشروع', en: 'Project name' },
  'pg.create':       { ar: 'إنشاء المشروع', en: 'Create project' },
  'pg.rename':       { ar: 'إعادة تسمية المشروع', en: 'Rename project' },
  'pg.remove':       { ar: 'إلغاء تجميع المشروع', en: 'Ungroup project' },
  'pg.removeConfirm':{ ar: 'سيتم إلغاء تجميع هذه البلوت كمشروع. تبقى البلوت وبياناتها كما هي.', en: 'These plots will no longer be grouped as one project. The plots and their data stay unchanged.' },
  'pg.partOf':       { ar: 'ضمن مشروع', en: 'Part of project' },
  'pg.kicker':       { ar: 'مشروع', en: 'PROJECT' },
  'pg.plotsWord':    { ar: 'بلوت', en: 'plots' },
  'cp.projectLabels':{ ar: 'إظهار أسماء المشاريع', en: 'Show project names' },
