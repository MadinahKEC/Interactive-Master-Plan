...
export const DICT: Record<string, Entry> = {
  ...
  'cp.filterHint':    { ar: 'اضغط لعرض المحدد فقط', en: 'click to show only selected' },
  'cp.soloHint':      { ar: 'اضغط لعرض هذا الاستخدام (واختر أكثر من واحد)؛ اضغط مجدداً لإلغائه', en: 'Click to show this use (pick more than one); click again to remove' },
  ...
  'loading':          { ar: 'جاري تحميل الخريطة التفاعلية…', en: 'Loading the interactive map…' },
  ...
  'a.plots':         { ar: 'البلوت والخطة', en: 'Plots & Plan' },
  ...
  'a.langDesc':      { ar: 'واجهة التطبيق بالعربية أو الإنجليزية.', en: 'Switch the interface between Arabic and English.' },
  'a.excelDesc':     { ar: 'تصدير كل بيانات القطع كملف CSV يفتح في Excel.', en: 'Export every plot as a CSV that opens in Excel.' },
  'a.exportDesc':    { ar: 'حفظ نسخة كاملة من كل التعديلات كملف JSON.', en: 'Save a full JSON snapshot of all overrides.' },
  'a.importDesc':    { ar: 'استعادة التعديلات من ملف JSON محفوظ سابقاً.', en: 'Restore overrides from a previously saved JSON file.' },
  'a.resetDesc':     { ar: 'حذف جميع التعديلات والعودة إلى بيانات الأساس. لا يمكن التراجع.', en: 'Delete all overrides and return to base data. This cannot be undone.' },
  'bk.restoreDesc':  { ar: 'استعادة نسخة احتياطية يومية محفوظة على Google Drive.', en: 'Restore a daily backup stored on Google Drive.' },
  ...
  'd.ownerName':     { ar: 'اكتب اسم المالك / الجهة', en: 'Enter owner / party name' },
  'd.setStatus':     { ar: 'حدّد حالة الملكية', en: 'Set ownership status' },
  'd.purchase':      { ar: 'تاريخ الشراء', en: 'Purchase date' },
  // — bulk ownership (multi-selection) —
  'mo.set':          { ar: 'تعيين حالة الملكية', en: 'Set ownership' },
  'mo.question':     { ar: 'هل المالك جهة واحدة أم جهات متعددة؟', en: 'One party, or multiple parties?' },
  'mo.same':         { ar: 'جهة واحدة للجميع', en: 'One party for all' },
  'mo.sameHint':     { ar: 'نفس المالك لكل البلوت المحددة', en: 'Same owner for every selected plot' },
  'mo.perPlot':      { ar: 'جهة مختلفة لكل بلوت', en: 'A different party per plot' },
  'mo.perPlotHint':  { ar: 'اكتب اسم الجهة المالكة لكل بلوت على حدة', en: 'Name the owning party for each plot' },
  'mo.apply':        { ar: 'تطبيق على المحدد', en: 'Apply to selection' },
  'mo.done':         { ar: 'تم تحديث حالة الملكية', en: 'Ownership updated' },
  // — change password —
  'pw.title':        { ar: 'تغيير كلمة المرور', en: 'Change password' },
  'pw.sub':          { ar: 'حدّث كلمة مرور حسابك', en: 'Update your account password' },
  ...
  'pw.save':         { ar: 'حفظ كلمة المرور', en: 'Save password' },
  'pw.saving':       { ar: 'جارٍ الحفظ…', en: 'Saving…' },
  'pw.hint':         { ar: '٦ أحرف على الأقل', en: 'At least 6 characters' },
  'pw.mismatch':     { ar: 'كلمتا المرور الجديدتان غير متطابقتين', en: 'The new passwords do not match' },
  'pw.short':        { ar: 'كلمة المرور قصيرة جداً (٦ أحرف على الأقل)', en: 'Password too short (at least 6 characters)' },
  'pw.wrong':        { ar: 'كلمة المرور الحالية غير صحيحة', en: 'The current password is incorrect' },
  'pw.same':         { ar: 'كلمة المرور الجديدة مطابقة للحالية', en: 'The new password matches the current one' },
  'pw.reauth':       { ar: 'انتهت الجلسة — سجّل الخروج ثم الدخول وحاول مجدداً', en: 'Session expired — sign out, sign in, then try again' },
  'pw.err':          { ar: 'تعذّر تغيير كلمة المرور', en: 'Could not change the password' },
  'pw.done':         { ar: 'تم تغيير كلمة المرور بنجاح', en: 'Password changed successfully' },
  ...
  'm.mergeName':     { ar: 'اسم القطعة بعد الدمج (إنجليزي)', en: 'Merged plot name (English)' },
  'm.mergeNameAr':   { ar: 'اسم القطعة بعد الدمج (عربي)', en: 'Merged plot name (Arabic)' },
  ...
  'd.favorite':      { ar: 'إضافة للمقارنة', en: 'Add to comparison' },
  'd.unfavorite':    { ar: 'إزالة من المقارنة', en: 'Remove from comparison' },
  'sl.clear':        { ar: 'مسح الكل', en: 'Clear all' },
  'sl.remove':       { ar: 'إزالة من المقارنة', en: 'Remove from comparison' },
  'cmp.title':       { ar: 'مقارنة البلوتات', en: 'Plot comparison' },
  'cmp.empty':       { ar: 'لا توجد بلوتات للمقارنة بعد', en: 'No plots to compare yet' },
  'cmp.emptyHint':   { ar: 'أضِف بلوتات للمقارنة عبر أيقونة النجمة ★ في بطاقة أي بلوت.', en: 'Add plots via the ★ on any plot card to compare them here.' },
  'cmp.needMore':    { ar: 'أضِف بلوتاً آخر على الأقل لبدء المقارنة الجانبية.', en: 'Add at least one more plot to compare side by side.' },
  ...
  'merged.breakdown':{ ar: 'تفصيل الأراضي المدموجة', en: 'Merged plots breakdown' },
  'merged.total':    { ar: 'إجمالي المساحة', en: 'Total area' },
  ...
  'tb.compare':      { ar: 'مقارنة البلوتات', en: 'Compare plots' },
  ...
  'dp.inPlan':       { ar: 'ضمن الخطة', en: 'In plan' },
  'dp.notInPlan':    { ar: 'خارج الخطة', en: 'Not in plan' },
  'dp.refine':       { ar: 'حصر النتائج بالفلاتر لعرض الكل', en: 'Refine filters to see all' },
