...
export const DICT: Record<string, Entry> = {
  ...
  'a.planFill':      { ar: 'لون التعبئة', en: 'Fill colour' },
  'a.planOutline':   { ar: 'لون الإطار', en: 'Outline colour' },
  'a.planDash':      { ar: 'إطار متقطّع', en: 'Dashed outline' },
  'a.planGlow':      { ar: 'هالة حسب الحالة', en: 'Status glow' },
  'a.planMarker':    { ar: 'شكل العلامة', en: 'Marker shape' },
  'a.planMarkerColor':{ ar: 'لون العلامة', en: 'Marker colour' },
  ...
  'sec.location':    { ar: 'ذكاء الموقع', en: 'Location intelligence' },
  'loc.haram':       { ar: 'المسجد النبوي', en: "Prophet's Mosque" },
  'loc.mosque':      { ar: 'أقرب مسجد', en: 'Nearest mosque' },
  'loc.mall':        { ar: 'أقرب مركز تسوّق', en: 'Nearest mall' },
  'loc.hospital':    { ar: 'أقرب مستشفى', en: 'Nearest hospital' },
  'loc.airport':     { ar: 'المطار', en: 'Airport' },
  'loc.education':   { ar: 'أقرب جامعة/مدرسة', en: 'Nearest campus' },
