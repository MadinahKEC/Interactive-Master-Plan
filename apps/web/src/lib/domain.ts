...
export const DICT: Record<string, Entry> = {
  ...
  'cp.filterHint':    { ar: 'اضغط الاسم للإخفاء · اللون للعرض وحده', en: 'name = toggle · colour = show only' },
  'cp.soloHint':      { ar: 'اعرض هذا الاستخدام وحده (اضغط مرة أخرى لعرض الكل)', en: 'Show only this land use (click again to show all)' },
