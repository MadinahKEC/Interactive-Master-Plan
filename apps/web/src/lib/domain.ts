...
export const DICT: Record<string, Entry> = {
  ...
  'a.backups':       { ar: 'النسخ الاحتياطية', en: 'Backups' },
  'bk.hint':         { ar: 'استعرض النسخ الاحتياطية اليومية من Google Drive واستعد أي نسخة. خاصية للمدير فقط.', en: 'Browse the daily Google Drive backups and restore any one. Administrator only.' },
