...
export const DICT: Record<string, Entry> = {
  ...
  'a.audit':         { ar: 'التراجع عن التعديلات', en: 'Undo changes' },
  'a.auditHint':     { ar: 'سجل التعديلات في هذه الجلسة — يمكنك التراجع إلى ما قبل أي تعديل. خاصية للمدير فقط.', en: 'Every change in this session — undo back to before any edit. Administrator only.' },
  'a.undoLast':      { ar: 'تراجع عن آخر تعديل', en: 'Undo last change' },
  'audit.revertOlderNote': { ar: 'التعديلات الأقدم من هذه الجلسة لا يمكن التراجع عنها.', en: 'Edits from earlier sessions cannot be undone.' },
